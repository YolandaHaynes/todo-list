  ...
  async function addTodo(todoTitle) {
    ...
    try {
      ...
      dispatch({
        ...
        payload: { tempId: newTodo.id, todo: data },
      });
    } catch (error) {
      dispatch({
        type: TODO_ACTIONS.ADD_TODO_ERROR,
        payload: { id: newTodo.id, error: `Error: ${error.message}` },
      });
    }
  }
  ...
  async function completeTodo(id) {
    ...
    try {
      ...
      dispatch({
        ...
        payload: { id, originalTodo, error: `Error: ${error.message}` },
      });
    }
  }
  ...
  return (
    <main className="page-container">
      <div className="todos-header">
        <h2>My Todos</h2>
        <p>Keep track of your tasks and let it help you stay organized. </p>
        ...
        <section className="todo-form-section" aria-label="Add a Todo">
          <h3>Add a Todo</h3>
          <TodoForm onAddTodo={addTodo} />
        </section>

        <section className="todo-list-section" aria-label="Todo List">
          <h3>Your Todos</h3>
