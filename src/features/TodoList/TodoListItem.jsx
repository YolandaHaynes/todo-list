...
//below is my code before changing to the above doing the assingments Stretch Goal (Optional): Create Custom Hook
//below is my own reference of how the code below uses use states versus custom hooks that's above
...
//     <li>
//       <form onSubmit={handleUpdate}>
//         {isEditing ? (<> <TextInputWithLabel value={workingTitle} onChange={handleEdit}/> 
